    ...
    albums: [
      {
        ...
        date: '01.06.2021',
        songs: [
          {title: 'Время', innerTitle: 'Time', duration: '04:18', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Излом', innerTitle: 'Break', duration: '03:25', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Грани', innerTitle: 'Edges', duration: '04:00', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Ангел мой', innerTitle: 'My-angel', duration: '03:52', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: '1/2', innerTitle: '1-2', duration: '11:12', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Мятежи пустых сердец', innerTitle: 'Riots-of-empty-hearts', duration: '06:33', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Атмосфера', innerTitle: 'Atmosphere', duration: '04:39', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Преданный', innerTitle: 'Betrayed', duration: '05:22', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Криминальные поступки', innerTitle: 'Criminal-acts', duration: '03:23', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Паразит', innerTitle: 'Parasite', duration: '04:25', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Мизантроп', innerTitle: 'Misanthrope', duration: '04:42', songHover: false, songActive: false, textHover: false, textActive: false},
          {title: 'Прототип', innerTitle: 'Prototype', duration: '04:50', songHover: false, songActive: false, textHover: false, textActive: false}
        ]
      }
    ]
  },
